...
const Footer = () => {
  ...
  const services = [
    'Dental Cleaning', 'Tooth Extraction', 'Dentures', 'Dental Fillings',
    'Teeth Whitening', 'Braces', 'Root Canal', 'Dental Implants'
  ];
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Book your appointment today and experience specialized dental care for you and your family.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-purple-300">Specialized Care for Families</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <p>123 Main Street, Hosur, Tamil Nadu</p>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="w-5 h-5 text-purple-400" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-3">
                {services.slice(0, 6).map((service) => (
                  <div key={service} className="text-gray-300 hover:text-white transition-colors">
                    {service}
                  </div>
                ))}
              </div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Sakthi Dental Clinic. All rights reserved.
            </p>
